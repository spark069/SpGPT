...
TOKEN = os.getenv('5539362606:AAFRMQ8NSBGa3_jiGSOZk88wlWnUNJ5E9Qs')
BOTNAME = os.getenv('Sp-GPT')
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text('Hello there. what is up? I will be happy to help you, سڵا وبەڕێزم، من لێرەم، چۆن ئەتوانم یارمەتیت بدەم؟')


# Lets us use the /help command
@user_allowed(users)
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text('Try typing anything and I will do my best to respond!، چیت هەیە و کێشەت چییە بینووسە، هەوڵ ئەدەم بە‌باشترین شێوە وەڵامت بدەمەوە.')
